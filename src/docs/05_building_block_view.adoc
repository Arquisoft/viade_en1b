...
| Redux module | Redux store in charge of state of the whole application.
...
* LoadActions: It has one action in order to change a propierty once the user logs in.
...
Redux module was in charge of managing the local state of the application. However, this SOLID module is actually in charge of managing the real data of the user fro the POD.

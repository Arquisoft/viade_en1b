...
| Building block       | Description
| Reducers             | Specify how the application´s state changes in response to actions sent to the store.
| Actions | Payloads of information that send data form our application to our store. They only describe _what happened_, but don´t edscribe how the application´s state changes.

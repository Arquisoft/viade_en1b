...
|Viade spec
|All the teams must agree in a specification in order to achieve the interoperability between different viade applications
|It is difficult to agree on something so specific with so many people
|===

.Table with Technical debt and a possible way of minimizing the
|===
